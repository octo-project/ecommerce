<template>
    <div id="click-away-modal" className="absolute !z-50 flex justify-center items-center top-0 left-0 w-full min-h-screen bg-[#232c2585]">
        <div className="bg-white modal-confirmation disabled-close w-[380px] md:w-md  rounded-lg flex justify-between flex-col ">
            ...
            <div className="disabled-close p-3 flex justify-end !space-x-2">
                ...
                <button @click="props.validate" className="disabled-close bg-blue-500 px-4 py-1 hover:bg-blue-700 rounded-lg text-white cursor-pointer">{{ props.okButtonLabel }}</button>
            </div> 
        </div>
    </div>
</template>
